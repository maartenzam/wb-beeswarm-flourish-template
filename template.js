...
`
  ...
  var root$8 = add_locations(/* @__PURE__ */ template2(`<div class="header svelte-1cps9pi"><h2 class="title svelte-1cps9pi"> </h2> <h3 class="subtitle svelte-1cps9pi"> </h3></div>`), Header[FILENAME], [[5, 0, [[6, 2], [7, 2]]]]);
  ...
  var root$7 = add_locations(/* @__PURE__ */ template2(`<div class="footer svelte-g4y3d9"><div class="notes svelte-g4y3d9"><span class="notes-title svelte-g4y3d9"> </span> </div> <!></div>`), Footer[FILENAME], [
    [6, 0, [[7, 4, [[7, 23]]]]]
  ]);
  ...
  var root_4$1 = add_locations(/* @__PURE__ */ ns_template(`<text class="tick-label svelte-1af89zx"> </text>`), NumericalColorLegend[FILENAME], [[150, 14]]);
  var root_6$1 = add_locations(/* @__PURE__ */ ns_template(`<text class="tick-label svelte-1af89zx"> </text>`), NumericalColorLegend[FILENAME], [[156, 16]]);
  var root_3$2 = add_locations(/* @__PURE__ */ ns_template(`<image class="gradient svelte-1af89zx" preserveAspectRatio="none"></image><rect class="gradient-border svelte-1af89zx"></rect><g class="ticks"><!><!></g>`, 1), NumericalColorLegend[FILENAME], [[132, 10], [141, 10], [148, 10]]);
  var root_8$2 = add_locations(/* @__PURE__ */ ns_template(`<rect></rect>`), NumericalColorLegend[FILENAME], [[165, 12]]);
  ...
  var root_2$3 = add_locations(/* @__PURE__ */ template2(`<div class="pill-container svelte-1ervix3"><div></div> <div> </div></div>`), CategoricalColorLegend[FILENAME], [[23, 6, [[24, 8], [25, 8]]]]);
  ...
  function ChartGrid($$anchor, $$props) {
    ...
    var node = child(g);
    {
        ...
        each(node_1, 17, () => get(formattedTicks), index, ($$anchor3, tick) => {
          ...
          template_effect(
            ($0) => {
              ...
              set_class(line, 0, `gridline ${(strict_equals(get(tick).value, 0) ? "zeroline" : "") ?? ""}`, "svelte-8ff1yv");
            },
            [
              () => isNaN($$props.scale(get(tick).value)) ? 0 : $$props.scale(get(tick).value)
            ]
      ...
      if_block(node, ($$render) => {
        if (equals($$props.gridType, "xGrid")) $$render(consequent_2);
      });
    }
    var node_4 = sibling(node);
    {
        ...
        each(node_5, 17, () => get(formattedTicks), index, ($$anchor3, tick, i) => {
          ...
          var node_7 = sibling(node_6);
          {
            ...
            if_block(node_7, ($$render) => {
              if (strict_equals(i, ticks2().length - 1) && $$props.axisTitle) $$render(consequent_4);
            });
          }
          template_effect(
            ($0) => {
              ...
              set_class(line_1, 0, `gridline ${(strict_equals(get(tick).value, 0) ? "zeroline" : "") ?? ""}`, "svelte-8ff1yv");
            },
            [
              () => isNaN($$props.scale(get(tick).value)) ? 0 : $$props.scale(get(tick).value)
            ]
      ...
      if_block(node_4, ($$render) => {
        if (equals($$props.gridType, "yGrid")) $$render(consequent_5);
      });
    }
              ...
              var consequent_2 = ($$anchor5) => {
                ...
                template_effect(
                  ...
                  [
                    ...
                    () => equals(get(valueType), "string") ? $$props.categoricalColorScale(get(bee).datum.color) : get(bee).datum.color ? $$props.numericalColorScale(get(bee).datum.color) : noDataColor
                  ]
                );
                event("focus", circle, () => {
                  set(currentFeature, proxy(get(bee).datum.id, null, currentFeature));
