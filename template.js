...
var __privateMethod = (obj, member, method) => (__accessCheck(obj, member, "access private method"), method);
  ...
  var root_2$4 = /* @__PURE__ */ template2(`<div class="pill-container svelte-hjs62s"><div></div> <div> </div></div>`);
  var root_3$3 = /* @__PURE__ */ template2(`<div class="pill-container svelte-hjs62s"><div></div> <div> </div></div>`);
  var root$6 = /* @__PURE__ */ template2(`<div><div class="legend-text-container svelte-hjs62s"><div class="legend-title svelte-hjs62s"><span> </span></div></div> <div class="categorical-legend svelte-hjs62s" aria-hidden="true"><!> <!></div></div>`);
  ...
  var root_2$3 = /* @__PURE__ */ template2(`<div class="no-data"><div class="no-data-symbol svelte-1af89zx"><svg class="no-data-symbol svelte-1af89zx"><rect class="no-data-rect"></rect></svg></div></div>`);
  ...
  var root_3$2 = /* @__PURE__ */ ns_template(`<image class="gradient svelte-1af89zx" preserveAspectRatio="none"></image><rect class="gradient-border svelte-1af89zx"></rect><g class="ticks"><!><!></g>`, 1);
  ...
  var root$5 = /* @__PURE__ */ template2(`<div><div class="legend-text-container svelte-1af89zx"><!> <div class="legend-title svelte-1af89zx"><span> </span>&nbsp;<span class="label-unit svelte-1af89zx"> </span></div></div> <div class="gradient-container svelte-1af89zx"><!> <div class="gradient svelte-1af89zx"><svg class="svelte-1af89zx"><!><!></svg></div></div></div>`);
  function ContinuousColorLegend($$anchor, $$props) {
    ...
    legacy_pre_effect(
      ...
      () => {
        set(discreteTicks, linearOrBinned() == "linear" ? [] : binningMode() == "fixedWidth" ? contColorScale().thresholds() : contColorScale().quantiles());
      }
    );
    ...
    var node_2 = child(svg_1);
    {
      ...
      if_block(node_2, ($$render) => {
        if (linearOrBinned() == "linear" && get(gradientWidth)) $$render(consequent_3);
      });
    }
    var node_6 = sibling(node_2);
    {
      ...
      if_block(node_6, ($$render) => {
        if (linearOrBinned() == "binned") $$render(consequent_4);
      });
    }
    template_effect(() => {
  ...
  function Tooltip($$anchor, $$props) {
    ...
    legacy_pre_effect(
      ...
      () => {
        if (get(component) && targetPos() && (targetPos().x !== get(lastTargetPos).x || targetPos().y !== get(lastTargetPos).y)) {
  ...
  var root_8 = /* @__PURE__ */ ns_template(`<text> </text>`);
              ...
              var consequent_2 = ($$anchor5) => {
                ...
                template_effect(
                  ...
                  [
                    ...
                    () => get(valueType) == "string" ? $$props.catColorScale(get(bee).datum.color) : getFill($$props.data, get(bee).datum.id, $$props.contColorScale, $$props.catColorScale, noDataColor)
                  ]
                );
      ...
      var consequent_5 = ($$anchor2) => {
        Tooltip($$anchor2, {
          ...
          children: ($$anchor3, $$slotProps) => {
            const expression_3 = /* @__PURE__ */ derived(() => get(currentFeatureData).value != null && get(currentFeatureData).value != "" ? get(valueType) == "number" ? Math.round(get(currentFeatureData).value * 10) / 10 : get(currentFeatureData).value : "No data");
  ...
  var root_2 = /* @__PURE__ */ template2(`<div class="legend-container svelte-1i5cyi5"><!> <!></div>`);
  var root = /* @__PURE__ */ template2(`<div class="chart-container svelte-1i5cyi5"><div class="header-container"><!></div> <div class="viz-container svelte-1i5cyi5"><!></div> <!> <div class="footer-container"><!></div></div>`);
  function Viz($$anchor, $$props) {
    ...
    let contColorScale = /* @__PURE__ */ derived(() => $$props.linearOrBinned == "linear" ? sequential(colorRamps[$$props.scaleType == "sequential" ? $$props.colorScale : $$props.colorScaleDiverging]).domain(get(dataExtent)) : $$props.binningMode == "fixedWidth" ? quantize(getDiscreteColors(colorRamps[$$props.scaleType == "sequential" ? $$props.colorScale : $$props.colorScaleDiverging], $$props.numberOfBins)).domain(get(dataExtent)) : quantile(getDiscreteColors(colorRamps[$$props.scaleType == "sequential" ? $$props.colorScale : $$props.colorScaleDiverging], $$props.numberOfBins)).domain($$props.data.plotdata.map((d) => d.value)));
    let colorDomain = /* @__PURE__ */ derived(() => {
      if (get(valueType) == "string") {
        return [
    ...
    let colorRange = /* @__PURE__ */ derived(() => {
      if (get(valueType) == "string") {
        ...
        if (range2.every((d) => d == noDataColor)) {
