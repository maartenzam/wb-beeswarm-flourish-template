...
var __privateMethod = (obj, member, method) => (__accessCheck(obj, member, "access private method"), method);
  ...
  var root$8 = /* @__PURE__ */ template2(`<div class="header svelte-1cps9pi"><h2 class="title svelte-1cps9pi"> </h2> <h3 class="subtitle svelte-1cps9pi"> </h3></div>`);
  ...
  var root_1$2 = /* @__PURE__ */ template2(`<div class="logo svelte-g4y3d9"><img alt="World Bank logo" class="svelte-g4y3d9"></div>`);
  var root$7 = /* @__PURE__ */ template2(`<div class="footer svelte-g4y3d9"><div class="notes svelte-g4y3d9"><span class="notes-title svelte-g4y3d9"> </span> </div> <!></div>`);
  ...
  var root_1$1 = /* @__PURE__ */ template2(`<div class="no-data-label svelte-1af89zx"> </div>`);
  var root_2$4 = /* @__PURE__ */ template2(`<div class="no-data"><div class="no-data-symbol svelte-1af89zx"><svg class="no-data-symbol svelte-1af89zx"><rect class="no-data-rect"></rect></svg></div></div>`);
  var root_4$1 = /* @__PURE__ */ ns_template(`<text class="tick-label svelte-1af89zx"> </text>`);
  var root_6$1 = /* @__PURE__ */ ns_template(`<text class="tick-label svelte-1af89zx"> </text>`);
  var root_3$3 = /* @__PURE__ */ ns_template(`<image class="gradient svelte-1af89zx" preserveAspectRatio="none"></image><rect class="gradient-border svelte-1af89zx"></rect><g class="ticks"><!><!></g>`, 1);
  var root_8$2 = /* @__PURE__ */ ns_template(`<rect></rect>`);
  var root_9 = /* @__PURE__ */ ns_template(`<text class="tick-label svelte-1af89zx"> </text>`);
  var root_7$2 = /* @__PURE__ */ ns_template(`<!><!>`, 1);
  var root$6 = /* @__PURE__ */ template2(`<div><div class="legend-text-container svelte-1af89zx"><!> <div class="legend-title svelte-1af89zx"><span> </span>&nbsp;<span class="label-unit svelte-1af89zx"> </span></div></div> <div class="gradient-container svelte-1af89zx"><!> <div class="gradient svelte-1af89zx"><svg class="svelte-1af89zx"><!><!></svg></div></div></div>`);
  function NumericalColorLegend($$anchor, $$props) {
    ...
    let discreteTicks = /* @__PURE__ */ derived(() => $$props.linearOrBinned == "linear" ? [] : $$props.binningMode == "fixedWidth" ? $$props.numericalColorScale.thresholds() : $$props.numericalColorScale.quantiles());
    var div = root$6();
    ...
    var node_2 = child(svg_1);
    {
      var consequent_3 = ($$anchor2) => {
        ...
        var node_4 = sibling(node_3);
        {
          ...
          if_block(node_4, ($$render) => {
            if (tickLabels().length === 0) $$render(consequent_2);
          });
        }
        template_effect(() => {
      ...
      if_block(node_2, ($$render) => {
        if ($$props.linearOrBinned == "linear" && get(gradientWidth)) $$render(consequent_3);
      });
    }
    var node_6 = sibling(node_2);
    {
      ...
      if_block(node_6, ($$render) => {
        if ($$props.linearOrBinned == "binned") $$render(consequent_4);
      });
    }
    template_effect(() => {
  ...
  var root_2$3 = /* @__PURE__ */ template2(`<div class="pill-container svelte-1ervix3"><div></div> <div> </div></div>`);
  var root_3$2 = /* @__PURE__ */ template2(`<div class="pill-container svelte-1ervix3"><div></div> <div> </div></div>`);
  var root$5 = /* @__PURE__ */ template2(`<div><div class="legend-text-container svelte-1ervix3"><div class="legend-title svelte-1ervix3"><span> </span></div></div> <div class="categorical-legend svelte-1ervix3" aria-hidden="true"><!> <!></div></div>`);
  ...
  class AccurateBeeswarm {
    ...
    withTiesBrokenRandomly() {
      this.tieBreakFn = this._sfc32(2654435769, 608135816, 3084996962, 1);
      return this;
    }
    ...
    _updateYBounds(item, all, pq) {
      for (let step of [-1, 1]) {
        let xDist;
        for (let i = item.index + step; i >= 0 && i < all.length && (xDist = Math.abs(item.x - all[i].x)) < this.diameter; i += step) {
          let other = all[i];
  ...
  class AccurateBeeswarmPriorityQueue {
    ...
    _siftDown(node = this.TOP) {
      let l, r;
      let sz = this.size();
      while (l = this.left(node), r = this.right(node), l < sz && this._greater(l, node) || r < sz && this._greater(r, node)) {
  ...
  function transformer$1() {
    var domain = unit, range2 = unit, interpolate$1 = interpolate, transform, untransform, unknown, clamp2 = identity$1, piecewise2, output, input;
    function rescale() {
    ...
    function scale(x) {
      return x == null || isNaN(x = +x) ? unknown : (output || (output = piecewise2(domain.map(transform), range2, interpolate$1)))(transform(clamp2(x)));
    }
    scale.invert = function(y) {
      return clamp2(untransform((input || (input = piecewise2(range2, domain.map(transform), interpolateNumber)))(y)));
    };
    scale.domain = function(_) {
  ...
  var root_3$1 = /* @__PURE__ */ ns_template(`<text class="tickLabel x middle svelte-8ff1yv"> </text>`);
  var root_2$2 = /* @__PURE__ */ ns_template(`<line></line><!>`, 1);
  var root_4 = /* @__PURE__ */ ns_template(`<text class="axisLabel middle svelte-8ff1yv"> </text>`);
  var root_1 = /* @__PURE__ */ ns_template(`<!><!>`, 1);
  var root_7$1 = /* @__PURE__ */ ns_template(`<text class="tickLabel y end svelte-8ff1yv"> </text>`);
  var root_8$1 = /* @__PURE__ */ ns_template(`<text class="axisLabel svelte-8ff1yv"> </text>`);
  var root_6 = /* @__PURE__ */ ns_template(`<line></line><!><!>`, 1);
  var root$4 = /* @__PURE__ */ ns_template(`<g><!><!></g>`);
  function ChartGrid($$anchor, $$props) {
    push($$props, true);
    let ticks2 = prop($$props, "ticks", 19, () => []), hideLines = prop($$props, "hideLines", 3, false), hideTickLabels = prop($$props, "hideTickLabels", 3, false), animated = prop($$props, "animated", 3, true);
    ...
    var node = child(g);
    {
      var consequent_2 = ($$anchor2) => {
        ...
        each(node_1, 17, () => get(formattedTicks), index, ($$anchor3, tick) => {
          ...
          var node_2 = sibling(line);
          {
            var consequent = ($$anchor4) => {
              ...
              template_effect(
                ($0) => {
                  set_attribute(text, "transform", `translate(${$0 ?? ""}, ${$$props.innerHeight + 18})`);
                  set_text(text_1, get(tick).label);
                },
                [
                  () => isNaN($$props.scale(get(tick).value)) ? 0 : $$props.scale(get(tick).value)
                ]
              );
              append($$anchor4, text);
            };
            if_block(node_2, ($$render) => {
              if (!hideTickLabels()) $$render(consequent);
            });
          }
          template_effect(
            ($0) => {
              set_attribute(line, "transform", `translate(${$0 ?? ""}, 0)`);
              set_attribute(line, "y1", hideLines() ? $$props.innerHeight + 5 : 0);
              set_attribute(line, "y2", $$props.innerHeight);
              set_class(line, 0, `gridline ${(get(tick).value === 0 ? "zeroline" : "") ?? ""}`, "svelte-8ff1yv");
            },
            [
              () => isNaN($$props.scale(get(tick).value)) ? 0 : $$props.scale(get(tick).value)
            ]
        ...
        var node_3 = sibling(node_1);
        {
          var consequent_1 = ($$anchor3) => {
            ...
            template_effect(() => {
              set_attribute(text_2, "x", $$props.innerWidth / 2);
              set_attribute(text_2, "y", $$props.innerHeight + 40);
              set_text(text_3, `${$$props.axisTitle ?? ""} ${($$props.axisUnits ? " (" + $$props.axisUnits + ")" : "") ?? ""}`);
            });
      ...
      if_block(node, ($$render) => {
        if ($$props.gridType == "xGrid") $$render(consequent_2);
      });
    }
    var node_4 = sibling(node);
    {
        ...
        each(node_5, 17, () => get(formattedTicks), index, ($$anchor3, tick, i) => {
          ...
          var node_6 = sibling(line_1);
          {
            var consequent_3 = ($$anchor4) => {
              ...
              template_effect(
                ($0) => {
                  set_attribute(text_4, "transform", `translate(${-8},${$0 ?? ""})`);
                  set_text(text_5, get(tick).label);
                },
                [
                  () => (isNaN($$props.scale(get(tick).value)) ? 0 : $$props.scale(get(tick).value)) + 4
                ]
              );
              append($$anchor4, text_4);
            };
            if_block(node_6, ($$render) => {
              if (!hideTickLabels()) $$render(consequent_3);
            });
          }
          var node_7 = sibling(node_6);
          {
            ...
            if_block(node_7, ($$render) => {
              if (i === ticks2().length - 1 && $$props.axisTitle) $$render(consequent_4);
            });
          }
          template_effect(
            ($0) => {
              set_attribute(line_1, "transform", `translate(0,${$0 ?? ""})`);
              set_attribute(line_1, "x1", hideLines() ? -5 : 0);
              set_attribute(line_1, "x2", hideLines() ? 0 : $$props.innerWidth);
              set_class(line_1, 0, `gridline ${(get(tick).value === 0 ? "zeroline" : "") ?? ""}`, "svelte-8ff1yv");
            },
            [
              () => isNaN($$props.scale(get(tick).value)) ? 0 : $$props.scale(get(tick).value)
            ]
      ...
      if_block(node_4, ($$render) => {
        if ($$props.gridType == "yGrid") $$render(consequent_5);
      });
    }
    template_effect(() => classes = set_class(g, 0, "", null, classes, { animated: animated() }));
    append($$anchor, g);
    pop();
  }
  const min = Math.min;
  ...
  var root$3 = /* @__PURE__ */ template2(`<div><!></div>`);
  function Tooltip($$anchor, $$props) {
    ...
    user_effect(() => {
      if (component && $$props.targetPos && ($$props.targetPos.x !== lastTargetPos.x || $$props.targetPos.y !== lastTargetPos.y)) {
  ...
  var root$2 = /* @__PURE__ */ template2(`<div class="tooltip-container svelte-7erzzb"><h3> </h3> <div> </div></div>`);
  ...
  var root_2$1 = /* @__PURE__ */ ns_template(`<text> </text>`);
  var root_3 = /* @__PURE__ */ ns_template(`<line></line>`);
  var root_7 = /* @__PURE__ */ ns_template(`<circle></circle>`);
  var root_8 = /* @__PURE__ */ ns_template(`<text paint-order="stroke" stroke-linejoin="round"> </text>`);
  var root$1 = /* @__PURE__ */ ns_template(`<svg><g><!></g><g><!><!><!><!></g></svg><!>`, 1);
  function Beeswarm($$anchor, $$props) {
    ...
    user_effect(() => {
      get(yDomain);
      set(yLabelsWidth, proxy(yLabels.getBBox().width));
    });
    ...
    let yDomain = /* @__PURE__ */ derived(() => {
      if (get(yBinding)) {
        ...
        let domainAverages = domain.map((d) => {
          let values = $$props.data.filter((c) => c.yValue == d && c.value != null).map((d2) => d2.value);
          let average = values.length > 0 ? values.reduce((total, next) => total + next) / values.length : 0;
          return { id: d, average };
        });
        if ($$props.ySort == "byAverage") {
    ...
    let beeswarmDataArray = /* @__PURE__ */ derived(() => {
      ...
      get(yDomain).forEach((c) => {
        let swarmData = get(yBinding) ? $$props.data.filter((d) => d.yValue == c && d.value !== null) : $$props.data.filter((d) => d.value !== null);
        swarms.push({
          id: c,
    ...
    let currentFeatureData = /* @__PURE__ */ derived(() => $$props.data.find((d) => d.id == get(currentFeature)));
    let mousePos;
          ...
          each(node_6, 17, () => get(swarm).data, index, ($$anchor4, bee) => {
            ...
            var node_7 = first_child(fragment_4);
            {
              var consequent_2 = ($$anchor5) => {
                var circle = root_7();
                circle.__mouseover = () => {
                  set(currentFeature, proxy(get(bee).datum.id));
                  tooltipVisible = true;
                };
                circle.__mouseout = () => {
                ...
                template_effect(
                  ($0, $1) => {
                    ...
                    set_attribute(circle, "stroke", get(bee).datum.id == get(currentFeature) ? wbColors.grey500 : $$props.beeStroke);
                    set_attribute(circle, "stroke-width", get(bee).datum.id == get(currentFeature) ? 2.5 : $$props.beeStrokeWidth);
                    set_attribute(circle, "opacity", $$props.beeOpacity);
                    set_attribute(circle, "fill", $1);
                  },
                  [
                    () => get(yScale)(get(swarm).id) + get(bee).y,
                    () => get(valueType) == "string" ? $$props.catColorScale(get(bee).datum.color) : get(bee).datum.color ? $$props.numericalColorScale(get(bee).datum.color) : noDataColor
                  ]
                );
                event("focus", circle, () => {
                  set(currentFeature, proxy(get(bee).datum.id));
      ...
      var consequent_5 = ($$anchor2) => {
        Tooltip($$anchor2, {
          ...
          children: ($$anchor3, $$slotProps) => {
            const expression_3 = /* @__PURE__ */ derived(() => get(currentFeatureData).value != null && get(currentFeatureData).value != "" ? format(",")(get(currentFeatureData).value) : "No data");
  ...
  var root_2 = /* @__PURE__ */ template2(`<!> <!>`, 1);
  var root = /* @__PURE__ */ template2(`<div class="chart-container svelte-1i5cyi5"><div class="header-container"><!></div> <div class="viz-container svelte-1i5cyi5"><!></div> <div class="legend-container svelte-1i5cyi5"><!></div> <div class="footer-container"><!></div></div>`);
  function Viz($$anchor, $$props) {
    ...
    let domainMinimum = /* @__PURE__ */ derived(() => typeof $$props.domainMin === "undefined" ? Math.floor(min$1($$props.data.plotdata.map((d) => d.color))) : $$props.domainMin);
    let domainMaximum = /* @__PURE__ */ derived(() => typeof $$props.domainMax === "undefined" ? Math.ceil(max$1($$props.data.plotdata.map((d) => d.color))) : $$props.domainMax);
    let dataDomain = /* @__PURE__ */ derived(() => extent($$props.data.plotdata, (d) => d.color));
    let customDomain = /* @__PURE__ */ derived(() => [
      get(domainMinimum),
      get(domainMaximum)
    ]);
    let domain = /* @__PURE__ */ derived(() => $$props.domainAutoCustom == "auto" ? get(dataDomain) : get(customDomain));
    ...
    Beeswarm(node_1, {
      ...
      get beeStrokeWidth() {
        return $$props.beeStrokeWidth;
      },
      get beeOpacity() {
        return $$props.beeOpacity;
      },
      get beeSpacing() {
    ...
    var node_2 = child(div_3);
    {
      var consequent_3 = ($$anchor2) => {
        ...
        var node_3 = first_child(fragment_1);
        {
          ...
          if_block(node_3, ($$render) => {
            if (get(valueType) == "number") $$render(consequent_1);
          });
        }
        var node_4 = sibling(node_3, 2);
        {
          ...
          if_block(node_4, ($$render) => {
            if (get(valueType) == "string") $$render(consequent_2);
          });
        }
        append($$anchor2, fragment_1);
      };
    ...
    bind_window_size("innerWidth", ($$value) => set(width, proxy($$value)));
    bind_window_size("innerHeight", ($$value) => set(height, proxy($$value)));
