...
`
  ...
  var root$3 = add_locations(/* @__PURE__ */ template2(`<div class="header svelte-1cps9pi"><h2 class="title svelte-1cps9pi"> </h2> <h3 class="subtitle svelte-1cps9pi"> </h3></div>`), Header[FILENAME], [[5, 0, [[6, 2], [7, 2]]]]);
  ...
  var root$2 = add_locations(/* @__PURE__ */ template2(`<div class="footer svelte-g4y3d9"><div class="notes svelte-g4y3d9"><span class="notes-title svelte-g4y3d9"> </span> </div> <!></div>`), Footer[FILENAME], [
    [6, 0, [[7, 4, [[7, 23]]]]]
  ]);
  ...
  var root_2 = add_locations(/* @__PURE__ */ ns_template(`<circle></circle>`), Beeswarm[FILENAME], [[34, 8]]);
  var root$1 = add_locations(/* @__PURE__ */ ns_template(`<g><!></g><line></line>`, 1), Beeswarm[FILENAME], [[31, 0], [45, 0]]);
  function Beeswarm($$anchor, $$props) {
    check_target(new.target);
    push($$props, true, Beeswarm);
    inspect(() => [$$props.height]);
    let margins = { top: 12, right: 12, left: 12 };
    ...
    let beeswarmData = /* @__PURE__ */ derived(() => new AccurateBeeswarm($$props.data.filter((d) => strict_equals(d.numericValue, null, false)), $$props.beeRadius, (d) => get(xScale)(d.numericValue)).calculateYPositions());
    var fragment = root$1();
    ...
    var node = child(g);
    {
      var consequent = ($$anchor2) => {
        ...
        each(node_1, 17, () => get(beeswarmData), index, ($$anchor3, bee) => {
          var circle = root_2();
          set_attribute(circle, "stroke", "black");
          set_attribute(circle, "stroke-width", 0);
          set_attribute(circle, "opacity", 0.5);
          template_effect(() => {
            set_attribute(circle, "r", $$props.beeRadius);
            set_attribute(circle, "cx", get(bee).x);
            set_attribute(circle, "cy", get(bee).y);
          });
    ...
    set_attribute(line, "stroke", "red");
    set_attribute(line, "stroke-width", 2);
    template_effect(() => {
      set_attribute(g, "transform", `translate(${margins.left}, ${$$props.height / 2 + margins.top})`);
      set_attribute(line, "x2", $$props.width);
      set_attribute(line, "y1", $$props.height / 2);
      set_attribute(line, "y2", $$props.height / 2);
    });
